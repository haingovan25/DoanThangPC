...
public class EditProductServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Product updatedProduct = new Product(id, categoryId, name, description, price, imageUrl);
        boolean success = productDAO.updateProduct(updatedProduct);

        if (success) {
            response.sendRedirect("admin-products.jsp"); // Đổi đường dẫn nếu bạn dùng servlet khác để hiển thị danh sách sản phẩm
        } else {
